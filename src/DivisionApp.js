...
export default function DivisionApp({ onBack, digits }) {
  ...
  function generateQuestion() {
    ...
    const divisor = Math.floor(Math.random() * 9) + 2; // avoid divide by 1 or 0
  ...
  return (
    <div className="p-6 max-w-md mx-auto bg-white rounded-2xl shadow-md space-y-6 border border-gray-300">
      ...
      <h1 className="text-2xl font-extrabold text-center text-gray-800 underline">Division ({digits}-Digit)</h1>

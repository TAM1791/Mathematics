...
export default function MultiplicationApp({ onBack }) {
  ...
  useEffect(() => setQuestion(generateQuestion()), []);
  ...
  return (
    <div className="p-6 max-w-md mx-auto bg-white rounded-2xl shadow-md space-y-6 border border-gray-300">
      ...
      <h1 className="text-2xl font-extrabold text-center text-gray-800 underline">Multiplication (2-Digit)</h1>
